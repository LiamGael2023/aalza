...
class tablaRequerimiento{
    ...
    public function mostrartablaRequerimiento() {
        ...
        $requerimiento = ControladorRequerimiento::ctrMostrarRequerimiento($item, $valor); 
  ...
  <a class="btn btn-sm btn-danger p-1 btnEliminarMarcaMedidor" data-idmarcamedidor='.$requerimientos["id"].'>
    <!-- Icono borrar -->
