...
class tablaDerechoUso{

    public function mostrartablaDerechoUso() {
        $item = null;
        $valor = null;

        $derechouso = ControladorDerechoUso::ctrMostrarDerechoUso($item, $valor); 
        ...
        foreach ($derechouso as $key => $derechousos) {
            ...
            $botones = '<td>'
                       ...
                       . '<a type="button" class="btn btn-light-warning btnEditarMarcaMedidor" id='.$derechousos["id"].' data-bs-toggle="modal" data-bs-placement="top" data-bs-target="#exampleModalEditar"><i class="fas fa-edit"></i></a>'
                       . '<a type="button" href="#" class="btn btn-light-secondary" title="Asignar Lotes" onclick="redirectToDetail('.$derechousos["id"].')"><i class="fas fa-list"></i></a>'
...
$activarDerechoUso = new tablaDerechoUso();
$activarDerechoUso->mostrartablaDerechoUso();
