...
class tablaDerechoUsoAgrario{

    public function mostrartablaDerechoUsoAgrario() {
        $item = null;
        $valor = null;

        $derechouso = ControladorDerechoUso::ctrMostrarDerechoUsoAgrario($item, $valor); 
...
$activarDerechoUso = new tablaDerechoUsoAgrario();
$activarDerechoUso->mostrartablaDerechoUsoAgrario();
