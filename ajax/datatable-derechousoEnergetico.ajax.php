...
class tablaDerechoUsoEnergetico{

    public function mostrartablaDerechoUsoEnergetico() {
        $item = null;
        $valor = null;

        $derechouso = ControladorDerechoUso::ctrMostrarDerechoUsoEnergetico($item, $valor); 
...
$activarDerechoUso = new tablaDerechoUsoEnergetico();
$activarDerechoUso->mostrartablaDerechoUsoEnergetico();
